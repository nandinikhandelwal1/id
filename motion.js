...
if (drawingsSection) {
  drawingsSection.innerHTML = `<div class="section-index">Technical language</div><div class="drawings-head"><h2>Drawings<br><i>meet space.</i></h2><p>Each study pairs the technical drawing with its 3D visual direction. Additional room renders can be added later without changing the layout.</p></div><div class="room-gallery"><article class="room-row"><div class="room-label"><h3>Flooring layout</h3><p>Plan study</p></div><figure class="room-panel"><img src="assets/drawings/Final layout Flooring..-Model-1.jpg" alt="Flooring layout drawing"><figcaption>AutoCAD drawing</figcaption></figure><figure class="room-panel room-empty"><div><span class="plus">+</span><p>3D render<br><small>Coming soon</small></p></div></figure></article><article class="room-row"><div class="room-label"><h3>Living elevation I</h3><p>Living room study</p></div><figure class="room-panel"><img src="assets/drawings/LIVING 1 FINAL-1.jpg" alt="Living elevation I drawing"><figcaption>AutoCAD drawing</figcaption></figure><figure class="room-panel room-empty"><div><span class="plus">+</span><p>3D render<br><small>Coming soon</small></p></div></figure></article><article class="room-row"><div class="room-label"><h3>Living elevation II</h3><p>Living room study</p></div><figure class="room-panel"><img src="assets/drawings/LIVING 2 FINAL-1.jpg" alt="Living elevation II drawing"><figcaption>AutoCAD drawing</figcaption></figure><figure class="room-panel room-empty"><div><span class="plus">+</span><p>3D render<br><small>Coming soon</small></p></div></figure></article><article class="room-row"><div class="room-label"><h3>Kitchen elevation</h3><p>Kitchen study</p></div><figure class="room-panel"><img src="assets/drawings/KITCHEN ELEVATION FINAL-1.jpg" alt="Kitchen elevation drawing"><figcaption>AutoCAD drawing</figcaption></figure><figure class="room-panel room-empty"><div><span class="plus">+</span><p>3D render<br><small>Coming soon</small></p></div></figure></article><article class="room-row"><div class="room-label"><h3>Bedroom elevation</h3><p>Guest bedroom study</p></div><figure class="room-panel"><img src="assets/drawings/BEDROOM ELEVATION-1.jpg" alt="Bedroom elevation drawing"><figcaption>AutoCAD drawing</figcaption></figure><figure class="room-panel"><img src="assets/renders/guest-bedroom-render.png" alt="Guest bedroom 3D render"><figcaption>3D render · guest bedroom</figcaption></figure></article></div>`;
}
